...
export const postRegister = (form) => async dispatch =>{
    ...
    try{
        ...
        const res = await axios.post(`http://localhost:5000/api/pulse/register/`, body, config);
...
export const getMeters = (form) => async dispatch =>{
    ...
    try{
        ...
        const res = await axios.post(`http://localhost:5000/api/pulse/register/get/meters`, body, config);
        console.log(res)
        dispatch({
