...
const RegistrationRightSection = ({data,orderPop, setChangePDP, rate, PUCT, provider, formData, mainFormIndex, setMainFormIndex, watt}) =>{
    ...
    return(
        <div className={'Rrs'}>
            ...
            <OrderDetails data={data} orderPop={orderPop} PUCT={PUCT} watt={watt} setChangePDP={setChangePDP} rate={rate} provider={provider}/>
